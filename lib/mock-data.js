...
export const CONTENTS_INIT = ["주간 활약","결투장","공성전","길드전","강림","개인 컨텐츠"];
...
export const CONTRIBS_INIT = {
  1:[
    {id:1,nick:"Zephyr",score:2841,pct:18.8,history:[{date:"2025.04.28",delta:"+33",note:"주간 활약 갱신"},{date:"2025.04.21",delta:"+41",note:"보상 참여"}]},
...
export const RADAR_LABELS = ["주간 활약","결투장","공성전","길드전","강림","개인"];
export const SIM_CONTENTS = ["주간 활약","결투장","공성전","길드전","강림"];

// 게임별 서버 랭킹 데이터 (컨텐츠별 점수 포함)
export const SERVER_RANKS_BY_GAME = {
  "로스트아크": [
    {name:"DragonBlood", ours:false, scores:{"주간 활약":4210,"결투장":3100,"공성전":2800,"길드전":3600,"강림":1200}},
    {name:"IronValor",   ours:false, scores:{"주간 활약":3988,"결투장":2900,"공성전":2600,"길드전":3400,"강림":1100}},
    {name:"StarFall",    ours:false, scores:{"주간 활약":3720,"결투장":2700,"공성전":2400,"길드전":3100,"강림": 980}},
    {name:"PhoenixRise", ours:false, scores:{"주간 활약":3540,"결투장":2500,"공성전":2200,"길드전":2900,"강림": 900}},
    {name:"CrystalEdge", ours:false, scores:{"주간 활약":3181,"결투장":2300,"공성전":2000,"길드전":2700,"강림": 820}},
    {name:"NightRaiders",ours:false, scores:{"주간 활약":3050,"결투장":2200,"공성전":1900,"길드전":2600,"강림": 780}},
    {name:"ShadowFang",  ours:true,  scores:{"주간 활약":2841,"결투장":1980,"공성전":1740,"길드전":2400,"강림": 720}},
    {name:"TerraForge",  ours:false, scores:{"주간 활약":2700,"결투장":1850,"공성전":1600,"길드전":2200,"강림": 680}},
    {name:"SkyBreaker",  ours:false, scores:{"주간 활약":2500,"결투장":1700,"공성전":1450,"길드전":2000,"강림": 620}},
  ],
  "블레이드&소울": [
    {name:"IronValor",   ours:true,  scores:{"주간 활약":3988,"결투장":3200,"공성전":2500,"길드전":3100,"강림":1050}},
    {name:"ShadowBlade", ours:false, scores:{"주간 활약":3700,"결투장":3000,"공성전":2300,"길드전":2900,"강림": 980}},
    {name:"CrimsonWing", ours:false, scores:{"주간 활약":3400,"결투장":2800,"공성전":2100,"길드전":2700,"강림": 900}},
    {name:"AzureStorm",  ours:false, scores:{"주간 활약":3100,"결투장":2600,"공성전":1900,"길드전":2500,"강림": 820}},
    {name:"GoldenFist",  ours:false, scores:{"주간 활약":2800,"결투장":2400,"공성전":1700,"길드전":2300,"강림": 740}},
  ],
  "메이플스토리": [
    {name:"PhoenixRise", ours:true,  scores:{"주간 활약":3540,"결투장":2800,"공성전":2200,"길드전":3000,"강림": 900}},
    {name:"MapleStar",   ours:false, scores:{"주간 활약":4100,"결투장":3300,"공성전":2700,"길드전":3500,"강림":1100}},
    {name:"BossClear",   ours:false, scores:{"주간 활약":3800,"결투장":3100,"공성전":2500,"길드전":3200,"강림":1020}},
    {name:"LeafOrder",   ours:false, scores:{"주간 활약":3200,"결투장":2600,"공성전":2000,"길드전":2800,"강림": 840}},
    {name:"CherryBomb",  ours:false, scores:{"주간 활약":2900,"결투장":2400,"공성전":1800,"길드전":2500,"강림": 760}},
  ],
};
// 기본 fallback (호환용)
export const SERVER_RANKS = SERVER_RANKS_BY_GAME["로스트아크"].map(r=>({name:r.name,score:r.scores["주간 활약"],ours:r.ours}));
export const GPT_REPORTS = [
  {id:1,date:"2025.04.28",title:"4월 4주차 주간 리포트",badge:"최신",guild:"ShadowFang",
   ...
   sections:[
     {title:"📊 성과 요약",content:"주간 점수 2,841점 달성 (전주 2,530 대비 +311). 참여율 87%로 전주 대비 3% 하락. 주간 활약 기여도 1위: Zephyr 523점."},
     {title:"🔥 MVP 분석",content:"Zephyr (딜러, Lv.85) — 주간 523점으로 1위. 전주 대비 33점 상승. 주간 활약·강림 콘텐츠에서 최상위 기록. 현재 S등급 유지 중."},
     {title:"⚠️ 개선 필요",content:"Vortex 등 7명의 참여율이 50% 미만. 주간 활약 참여 독려 권장. IceWolf의 점수가 2주 연속 정체 중이며 개인 컨텐츠 참여 독려 필요."},
  ...
  {id:2,date:"2025.04.21",title:"4월 3주차 주간 리포트",badge:"",guild:"ShadowFang",
   ...
   sections:[
     ...
     {title:"⚠️ 개선 필요",content:"주간 활약 평균 점수 전주 대비 5% 하락. 딜러진 강화 필요."},
     {title:"🎯 다음 주 전략",content:"주간 활약 집중 공략. 하위 참여자 5명 독려 계획."},
   ],
   chips:["MVP: LunaX","길드전 +22%","주간 활약 개선 필요"]},
];
